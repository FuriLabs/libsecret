...
/*
 * Generated by gdbus-codegen 2.58.3 from org.freedesktop.Secrets.xml. DO NOT EDIT.
 *
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        __secret_gen_service_schedule_emit_changed (skeleton, (const _ExtendedGDBusPropertyInfo *) __secret_gen_service_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
  ...
  GParamSpec   *pspec)
{
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        __secret_gen_collection_schedule_emit_changed (skeleton, (const _ExtendedGDBusPropertyInfo *) __secret_gen_collection_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
      g_value_copy (value, &skeleton->priv->properties[prop_id - 1]);
      g_object_notify_by_pspec (object, pspec);
    }
  g_mutex_unlock (&skeleton->priv->lock);
  ...
  GParamSpec   *pspec)
{
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        __secret_gen_item_schedule_emit_changed (skeleton, (const _ExtendedGDBusPropertyInfo *) __secret_gen_item_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
      g_value_copy (value, &skeleton->priv->properties[prop_id - 1]);
      g_object_notify_by_pspec (object, pspec);
    }
  g_mutex_unlock (&skeleton->priv->lock);
